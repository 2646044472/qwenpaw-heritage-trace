...
export function LandingPage() {
  return (
    <main className="bg-heritage-surface text-foreground">
      <section className="relative isolate flex min-h-[calc(100svh-72px)] items-center overflow-hidden px-6 py-16 sm:px-10 lg:px-16">
        <div className="mx-auto grid w-full max-w-[1280px] items-center gap-14 lg:grid-cols-[minmax(0,0.86fr)_minmax(360px,1.14fr)] lg:gap-20">
          <div className="max-w-xl">
            ...
            <Link
              className="group mt-10 inline-flex min-h-12 items-center gap-3 border-heritage border-b pb-2 font-semibold text-heritage text-sm transition-colors hover:border-heritage-gold hover:text-heritage-gold focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-heritage-gold focus-visible:ring-offset-4"
          ...
          <figure className="relative aspect-[4/5] max-h-[620px] overflow-hidden bg-heritage-soft/30">
            ...
            <figcaption className="absolute inset-x-5 bottom-5 flex items-end justify-between gap-4 text-xs sm:inset-x-7 sm:bottom-7">
              <div>
                <p className="font-heritage-display text-2xl text-foreground sm:text-3xl">禮記雪糕</p>
      ...
      <section className="border-heritage-border border-t px-6 py-24 sm:px-10 sm:py-28 lg:px-16" id="journey">
        <div className="mx-auto max-w-[1200px]">
          ...
          <div className="mt-12 border-heritage-border border-t">
            {journey.map((step) => (
              <div
                className="group grid gap-3 border-heritage-border border-b py-7 sm:grid-cols-[72px_220px_minmax(0,1fr)] sm:items-baseline sm:gap-8"
                key={step.number}
              >
                <span className="font-mono text-heritage-gold text-xs">{step.number}</span>
                <h2 className="font-heritage-display text-3xl tracking-tight transition-transform group-hover:translate-x-1 sm:text-4xl">
                  {step.role}
                </h2>
        ...
        <div className="mx-auto grid max-w-[1200px] items-center gap-14 lg:grid-cols-[minmax(0,1fr)_minmax(320px,0.72fr)] lg:gap-24">
          ...
          <article className="max-w-[390px] border border-heritage-border bg-background p-7 sm:p-9">
            ...
            <div className="mt-12 border-heritage-border border-b pb-7">
              <h3 className="font-heritage-display text-3xl">禮記雪糕</h3>
      ...
      <section className="bg-heritage px-6 py-24 text-heritage-foreground sm:px-10 sm:py-28 lg:px-16">
        <div className="mx-auto flex max-w-[1200px] flex-col items-start gap-10 sm:flex-row sm:items-end sm:justify-between">
          ...
          <div className="flex flex-col items-start gap-6 sm:items-end">
            ...
            <p className="font-mono text-heritage-foreground/60 text-xs">Government → Merchant → Hunter</p>
          </div>
        </div>
      </section>
    </main>
